...
namespace Lab3
{
    class Program
    {
        ...
        /// <summary>
        /// order function method for finding the order for vertices
        /// </summary>
        /// <param name="matrix">matrix without contures</param>
        /// <returns>array of levels for each verticies</returns>
        ...
        /// 
        /// </summary>
        /// <param name="file">name file of csv type file</param>
        /// <returns>adjacency matrix</returns>
        static bool[,] GetMatrixFromCSV(string file)
        {
            return GetMatrixFromCSV(file, out bool orgraph);
        }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="file">name file of csv type file</param>
        /// <param name="orgraph">Is a returned matrix the orgraph?</param>
        /// <returns>adjacency matrix</returns>
